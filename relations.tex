...
burst index without further evidence.  Its upstream launch-input constructor
initializes the field to zero, but this does not establish that subsequent
writers leave it zero for ordinary shots.  The subsequent arithmetic is
\begin{equation}
...
Ordinary firing route & \texttt{0x142f7c754}\\
...
Writers of that input or the corresponding firing-object field
\texttt{+0x64} remain inspection targets; the counter's meaning is unresolved.
