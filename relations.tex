...
effective shooter accuracy and effective projectile marksmanship, respectively;
$b$ includes conditional accessor additions to the base projectile value.
The angle $\theta$ is the stored launch elevation.  The symbol $M$ collects two multiplicative
